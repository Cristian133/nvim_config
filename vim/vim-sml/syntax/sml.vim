...
syn region   smlModParam start="([^*]" end=")" contained contains=@smlAENoParen,smlModParam1,smlModParamNameKw
syn match    smlModParam1 "\<\u\(\w\|'\)*\>" contained skipwhite skipempty nextgroup=smlPreMPRestr
syn match    smlModParamNameKw '\<structure\>' skipwhite nextgroup=smlModParamName contained
syn match    smlModParamName "\<\u\(\w\|'\)*\>" contained skipwhite nextgroup=smlMPRestr
...
syn region   smlFuncWith start="([^*]"me=e-1 end=")" contained contains=smlComment,smlWith,smlFuncStruct,smlFuncStructName
...
syn region   smlFuncStruct2 matchgroup=smlModule start="struct\>" matchgroup=smlModule end="\<end\>" contains=ALLBUT,@smlContained,smlEndErr
syn match    smlFuncStructName '\<structure\>' skipwhite nextgroup=smlFuncStructNameStruct1 contained
syn match    smlFuncStructNameStruct1 "\<\u\(\w\|'\)*\>" contained skipwhite nextgroup=smlFuncStructNameAssignment
syn match    smlFuncStructNameAssignment '=' skipwhite nextgroup=smlFuncStruct2,smlFuncStructNameStruct2 contained
syn match    smlFuncStructNameStruct2 "\<\u\(\w\|'\)*\>" contained skipwhite nextgroup=smlFuncStructName
...
syn match    smlWith "\<\(structure\)\@!\(\u\(\w\|'\)*\.\)*\w\(\w\|'\)*\>" contained skipwhite skipempty nextgroup=smlWithRest
...
if version >= 508 || !exists("did_sml_syntax_inits")
  ...
  HiLink smlModPath	 Identifier
  HiLink smlModule	 Identifier
  HiLink smlModParam1	 Include
  HiLink smlModType	 Include
  HiLink smlMPRestr3	 Include
  HiLink smlFullMod	 Identifier
  HiLink smlModTypeRestr Identifier
  HiLink smlWith	 Include
  HiLink smlMTDef	 Include
  HiLink smlFuncStructNameStruct1 Include
  HiLink smlFuncStructNameStruct2 Include
  HiLink smlModParamName Include
  ...
  HiLink smlFuncStructName Keyword
  HiLink smlModParamNameKw Keyword
  ...
  HiLink smlFuncStructNameAssignment Operator
